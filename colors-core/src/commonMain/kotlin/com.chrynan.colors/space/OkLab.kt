...
class OkLab(
    ...
    override fun getMinValue(component: Int): Float = if (component == 0) 0f else -2f

    override fun getMaxValue(component: Int): Float = if (component == 0) 1f else 2f
    ...
    companion object {
        ...
        private val M1 = mul3x3(
            ...
            chromaticAdaptation(
                matrix = Adaptation.VON_KRIES.transform,
