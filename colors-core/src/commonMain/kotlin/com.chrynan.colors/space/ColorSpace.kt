 ...
 * threads.
 *
 * @property [name] Returns the name of this color space. The name is never null
 ...
 * color models. For instance: [Generic L*a*b*][ColorSpaces.CIE_LAB].
 ...
 * white point, etc.
 *
 * @property [model] The color model of this color space.
 *
 * @property [id] The ID of this color space. Positive IDs match the color
...
abstract class ColorSpace internal constructor(
    ...
    constructor(name: String, model: ColorModel) : this(name, model, MIN_ID)
     ...
     * 90% of greater than the area of the [NTSC][ColorSpaces.NTSC_1953]
     * gamut.
     *
    ...
    init { // ColorSpace init
        if (name.isEmpty()) {
            throw IllegalArgumentException("The name of a color space cannot be null and must contain at least 1 character")
        }
     ...
     */
    /*@Size(3)*/
    fun toXyz(r: Float, g: Float, b: Float): FloatArray = toXyz(floatArrayOf(r, g, b))
     ...
     */
    override fun toString(): String = "$name (id=$id, model=$model)"
    ...
    companion object {
         ...
         * @see id
         */
        const val MIN_ID = -1 // Do not change
         ...
         * @see id
         */
        const val MAX_ID = 63 // Do not change, used to encode in longs
    }
}
