...
class LabColorSpace(
    ...
    override fun getMinValue(component: Int): Float = if (component == 0) 0.0f else -128.0f

    override fun getMaxValue(component: Int): Float = if (component == 0) 100.0f else 128.0f
