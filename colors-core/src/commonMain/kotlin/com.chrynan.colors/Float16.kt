...
internal inline class Float16(@Suppress("MemberVisibilityCanBePrivate") val halfValue: Short) : Comparable<Float16> {
    ...
    fun withSign(sign: Float16): Float16 =
        Float16((sign.halfValue.toInt() and FP16_SIGN_MASK or (halfValue.toInt() and FP16_COMBINED)).toShort())
     ...
     */
    fun absoluteValue(): Float16 = Float16((halfValue.toInt() and FP16_COMBINED).toShort())
    ...
    fun isNormalized(): Boolean =
        halfValue.toInt() and FP16_EXPONENT_MAX != 0 &&
